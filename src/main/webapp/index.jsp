...
<html lang="zh"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" src="statics/echarts/echarts.js"></script>
    <!-- 配置文件 -->
    ...
    <!--百度地图API-->
    <script type="text/javascript" src="https://api.map.baidu.com/api?v=2.0&&type=webgl&ak=Ff5xj7MK7KDgWIvn0IAD57fqYM4oiC7L"></script>
    <style type="text/css">
        body {
            padding-top: 60px;
            padding-bottom: 40px;
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <form class="navbar-form navbar-right" role="search" action="index" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" value=""  placeholder="搜索云记">
                </div>
    ...
    <div class="row-fluid">
        <div class="col-md-3">
                ...
                <div>
                    <ul class="nav nav-pills nav-stacked">
                        <c:forEach items="${dateList}" var="item">
                            ...
                            <li><a href="index?act=seachDate&dateName=${item.groupName}"> ${item.groupName}<span class="badge">${item.count}</span></a></li>
                        </c:forEach>
            ...
            <div class="data_list">
                ...
                <div>
                    <ul class="nav nav-pills nav-stacked" id="navTypeList">
                        <c:forEach items="${navTypeList}" var="item">
                            <li id="li_${item.typeId}"><a href="index?act=seachType&typeId=${item.typeId}"><span id="sp_2">${item.groupName}</span> <span class="badge">${item.count}</span></a></li>
                        </c:forEach>
